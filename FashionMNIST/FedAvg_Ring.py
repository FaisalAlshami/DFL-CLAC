...
def fashionmnist_fedavg_ring(alpha=0.5, num_classes=10, num_clients=20, num_rounds=20, num_epochs=20,
                        batch_size=32, cluster_num=5, num_components=50, max_delay=60, selected_ratio=0.8, Allow_delay=60,
                        aggregation="FedAvg", topology="Star", dirName="FMNIST_FedAvg"):
    ...
    model_path = os.path.join(log_file, "global_model_FashionMNIST_fedavg_ring.pth")
    torch.save(global_model.state_dict(), model_path)


if __name__ == "__main__":
    # Delay allows to clients Allow_delay
    fashionmnist_fedavg_ring(alpha=0.5, num_classes=10, num_clients=20, num_rounds=10, num_epochs=20,
                        batch_size=128, cluster_num=12, num_components=100, selected_ratio=0.9, Allow_delay=180,
                        aggregation="FedAvg", topology="Ring", dirName="FashionMNIST_FedAvg_Ring")

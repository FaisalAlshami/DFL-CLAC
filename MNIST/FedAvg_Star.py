...
def mnist_fedavg_star(alpha=0.5, num_classes=10, num_clients=20, num_rounds=20, num_epochs=20,
...
if __name__ == "__main__":
    ...
    mnist_fedavg_star(alpha=0.5, num_classes=10, num_clients=30, num_rounds=100, num_epochs=20,
                        batch_size=128, cluster_num=12, num_components=100, selected_ratio=0.9, Allow_delay=180,
                        aggregation="FedAvg", topology="Star", dirName="MNIST_FedAvg")

...
def cifar10_dfl_clac_star(
    ...
    logging.info(
        "\n".join([
            "Scenario: CIFAR10 with DFL-CLAC",
    ...
    for r in range(num_rounds):
        ...
        for cid in chosen:
            client_model = CIFAR10CNNModel().to(device)

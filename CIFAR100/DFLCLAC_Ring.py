...
def cifar100_dfl_clac_ring(
    ...
    topology: str = "Ring",
    dirName: str = "CIFAR100_DFL_CLAC_Ring",
):
    """
    Simulate DFL-CLAC on CIFAR-100 under a *Ring* (decentralized) topology.
    ...
    base_model = CIFAR100ModelCNN().to(device)
    ...
    for r in range(num_rounds):
        ...
        pseudo_global = CIFAR100ModelCNN().to(device)

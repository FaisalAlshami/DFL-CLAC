...
def cifar100_dfl_clac_star(
    ...
    topology: str = "Star",
    dirName: str = "CIFAR100_DFL_CLAC",
):
    """
    Simulate DFL-CLAC on CIFAR-10 under a Star topology.
    ...
    logging.info(
        "\n".join([
            "Scenario: CIFAR100 with DFL-CLAC",
    ...
    clients: List[nn.Module] = [CIFAR100ModelCNN().to(device) for _ in range(num_clients)]
    for c in clients:
    ...
    for r in range(num_rounds):
        ...
        for cid in chosen:
            client_model = CIFAR100ModelCNN().to(device)
...
if __name__ == "__main__":
    cifar100_dfl_clac_star(
        ...
        topology="Star",
        dirName="CIFAR100_DFL_CLAC_Star",
    )

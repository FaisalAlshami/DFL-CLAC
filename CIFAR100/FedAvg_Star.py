...
def cifar100_fedavg_star(alpha=0.5, num_classes=100, num_clients=20, num_rounds=20, num_epochs=20,
...
if __name__ == "__main__":
    ...
    cifar100_fedavg_star(alpha=0.5, num_classes=100, num_clients=20, num_rounds=10, num_epochs=20,
